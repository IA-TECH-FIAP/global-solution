...
export default function CopilotChat({ sensors, selectedSensorId, onSelectSensor }) {
  ...
  return (
    <>
      {/* Backdrop do Modal */}
      {isMaximized && <div className="modal-backdrop active" onClick={() => setIsMaximized(false)} />}

      <section className={`card ${isMaximized ? 'maximized' : ''}`} id="copilot-section" style={{ height: '100%' }}>
